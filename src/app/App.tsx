...
export default function App() {
  ...
  return (
    <div className="bg-[#0a0a0a] text-[#f0f0f0] font-sans w-screen h-screen overflow-hidden select-none relative">
      ...
      {/* Logo */}
      <div className="fixed top-6 left-6 md:top-10 md:left-10 text-[22px] md:text-[28px] font-semibold tracking-wide z-50 pointer-events-none text-[#f0f0f0] capitalize">
        jeonkicheol
      </div>
